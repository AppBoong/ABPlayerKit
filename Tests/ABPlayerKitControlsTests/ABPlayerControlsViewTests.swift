...
@Suite("Controls attach and detach without leaking observation", .timeLimit(abScaledMinutes(3)))
@MainActor
...
@Suite("Controls promote a non-current player to current on a play tap", .timeLimit(abScaledMinutes(3)))
@MainActor
...
@Suite("Controls reflect engine events", .timeLimit(abScaledMinutes(3)))
@MainActor
...
@Suite("Controls follow the release overlay geometry", .timeLimit(abScaledMinutes(3)))
@MainActor
...
@Suite("Skip buttons dispatch through ABControlsPresenter to the player and to observers", .timeLimit(abScaledMinutes(3)))
@MainActor
